    ...
    var init = function (appId, clientId) {
        ...
        new Vue({
            ...
            methods: {
                auth: function () {                 
                    authWin = window.open(
                        "https://app.asana.com/-/oauth_authorize?response_type=token&client_id=" + clientId + "&redirect_uri=https%3A%2F%2Flocalhost%3A44323%2Fapps%2FB309F192-9F22-4E39-AAFC-DD59589227C7%2Fauth&state=somerandomstate",
                        "authWindow",
