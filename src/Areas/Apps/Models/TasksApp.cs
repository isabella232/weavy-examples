...
namespace Weavy.Areas.Apps.Models {
    ...
    [App(Icon = "outline-assignment", Name = "Tasks", Description = "A task management app.", AllowMultiple = true, Content = new Type[] { typeof(TaskItem) }, AllowContentWithSameName = true)]
