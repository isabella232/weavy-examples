...
/* CHANGES BY WEAVY:
 - window.encodeURIComponent() -> encodeURIComponent() / for issue with Firefox extension
 - add local variable to ajaxAbort due to incorrect minification (see comment)
